...
public class JsonDecompose {
    ...
    public class Number {
        private String code;//车牌号头两位
        private String city;//城市
        private String province;//省份
        private String Pcode;//省份缩写
    ...
    public static void main(String[] args) {
        ...
        JSONArray jsonObject2 = JSONArray.fromObject(result);
        for (Iterator<Object> iterator = jsonObject2.iterator(); iterator.hasNext();) {
